...
const translations = {
  EN: {
    systemDoc: "Terminal Clock Documentation",
    status: "Instalation & Setup",
    optimized: "Easy",
    logic: "Core Engine",
    auth: "Interface",
    speed: "Update Rate",
    engineeringTitle: "Technical Breakdown",
    defaultDescription: "A lightweight terminal clock that not only tells the time in a sleek minimalist way, but also diplays the CPU and RAM usage.",
    quote: "Code is like humor. When you have to explain it, it’s bad.",
    envSetup: "Installation & Execution",
    perfBench: "Resource Utilization",
    process: "Subsystem",
    latency: "Performance",
    edgeFetch: "Clock Sync & Logic",
    hydration: "Terminal Buffer",
    continueConvo: "Explore Codebase",
    inquireNow: "GitHub Repository"
  },
  CZ: {
    systemDoc: "Dokumentace hodin v terminálu",
    ...
    defaultDescription: "Jednoduché terminálové hodiny, které velmi jednouše zobrazují čas a užití procesoru a paměti RAM.",
    quote: "V jednoduchosti je krása.",
    envSetup: "Instalace a spuštění",
    perfBench: "Využití zdrojů",
    process: "Subsystém",
    latency: "Výkon",
    edgeFetch: "Synchronizace času",
    hydration: "Buffer terminálu",
...
export default function ProjectPage({ setCurrentPage }) {
  ...
  const project = {
    ...
    year: "2026",
    description: {
  EN: "A robust TUI clock and system monitor built with Textual and psutil. It features real-time performance tracking for CPU and RAM, utilizing dynamic color-coding (White to Red) to visualize system load at a glance.",
  CZ: "Jednoduché digitalní hodiny a monitor systému postavený na knihovnách Textual a psutil. Nabízí sledování výkonu CPU a RAM s využitím barevného rozlišení (od bílé po červenou) pro okamžitý přehled o vytížení systému."
},
    tags: ["Python", "ASCII", "CLI", "Time Management"]
  };
  ...
  { label: t.logic, val: "Python 3.10+", icon: <Cpu size={14}/> }, // Změněno na CPU icon pro jádro
  { label: t.auth, val: "Textual", icon: <Layout size={14}/> },
  { label: t.speed, val: "1Hz", icon: <Clock size={14}/> }
].map((w, i) => (
      ...
      <main className="max-w-6xl mx-auto px-6 py-24 pb-64">
        <article className="space-y-24">
          ...
          <section>
            ...
            <CodeBlock 
              isDark={isDark}
              filename="terminal"
              code={`# Clone the repository\ngit clone https://github.com/SimpleCarrot42/TerminalClock.git\n\n# Navigate and run\npip install textual psutil \ncd TerminalClock\npython clock.py`}
            />
          </section>
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className={`divide-y ${
                  ...
                  <tr>
                    ...
                    <td className="p-5 font-mono text-orange-600">&lt; 1% CPU</td>
                  </tr>
                  <tr>
                    <td className="p-5 font-medium">{t.hydration}</td>
                    <td className="p-5 font-mono text-orange-600">~15MB RAM</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className="flex flex-col items-center justify-center mt-32 text-center">
            ...
            <a 
              href="https://github.com/SimpleCarrot42/TerminalClock" 
              target="_blank" 
