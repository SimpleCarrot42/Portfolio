...
import ProjectDetailPage from "../../components/projects/utilitybot"; 

export default function GoDrivePage() {
  const project = allProjects.find((p) => p.slug === "utilitybot");

  if (!project) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p>Project not found in data/projects.js</p>
      </div>
    );
  }
